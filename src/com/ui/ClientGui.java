...
import com.analyze.AnalyseList;
import com.analyze.SemanticAnalyse;
import com.analyze.TextLex;
import com.analyze.TextParse;
...
class LexFrame extends JFrame implements ActionListener{
	...
	public void initPanel(){
		...
		lb_lex_result = new JLabel("lexical");
...
//		btn_cleardata.addActionListener(this);
		...
		lb_triples = new JLabel("Triple");
		main_panel.add(lb_triples);
		lb_triples.setBounds(830,360, 80, 20);
		
		tbmodel_triples = new DefaultTableModel(null, new String[]{"序号","四元式"});
		tb_triples = new JTable(tbmodel_triples);
		tb_triples.setEnabled(true);
