...
public class SemanticAnalyse{
	...
	public void Parsing(){
		...
		System.out.println("MOV A, 10");
		System.out.println("MOV B0, A");
		System.out.println("SUB B0, 0");
		System.out.println("JNS L4");
		System.out.println("JMP L6");
		System.out.println("MOV A, 1");
		System.out.println("JMP L7");
		System.out.println("MOV A, 2");
		System.out.println("MOV B1, A");
		System.out.println("SUB B1, 0");
		System.out.println("JNS L10");
		System.out.println("JMP L12");
		System.out.println("MOV A, 3");
		System.out.println("JMP L7");
	}
